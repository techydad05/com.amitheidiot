...
const sampleQuestions = [
  {
    ...
    options: JSON.stringify(["The Constitution", "The Bill of Rights", "The Declaration of Independence", "Federal Law"]),
    correct_answer: 0
  },
  {
    question: "What does the Constitution do?",
    options: JSON.stringify(["Sets up the government", "Defines the government", "Protects basic rights of Americans", "All of the above"]),
    correct_answer: 3
  },
  {
    question: "The idea of self-government is in the first three words of the Constitution. What are these words?",
    options: JSON.stringify(["We the People", "We the Citizens", "We the Americans", "We the Nation"]),
    correct_answer: 0
  },
  {
    question: "What is an amendment?",
    options: JSON.stringify(["A change to the Constitution", "An addition to the Constitution", "Both A and B", "A law passed by Congress"]),
    correct_answer: 2
  },
  {
    question: "What do we call the first ten amendments to the Constitution?",
    options: JSON.stringify(["The Bill of Rights", "The First Amendments", "The Constitutional Rights", "The Basic Laws"]),
    correct_answer: 0
  },
  {
  ...
  },
  {
    ...
    options: JSON.stringify(["Announced our independence from Great Britain", "Declared our independence from Great Britain", "Said that the United States is free from Great Britain", "All of the above"]),
    correct_answer: 3
  },
  {
    question: "What are two rights in the Declaration of Independence?",
    options: JSON.stringify(["Life and liberty", "Liberty and the pursuit of happiness", "Life, liberty, and the pursuit of happiness", "Freedom and justice"]),
    correct_answer: 2
  },
  {
    question: "What is freedom of religion?",
    options: JSON.stringify(["You can practice any religion", "You can practice any religion, or not practice a religion", "You must practice a religion", "You cannot practice a religion"]),
    correct_answer: 1
  }
];
